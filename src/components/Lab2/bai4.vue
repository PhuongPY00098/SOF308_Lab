<template>
    <div class="container mt-3">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Tài khoản</button>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div cLass="modal-body">
                    <!-- Đoạn mã tạo Tab ở bài 3 dán ở đây -->
                    <div cLass="container mt-3">
                    <!-- Nav tabs -->
                    ...
                    <div class="tab-content"> 
                        <div id="register" class="container tab-pane active"><br>
                            <!-- Form đăng ký -->
                            <div class="col-10 px-2 mx-auto border">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="pwd" placeholder="Xác nhận mật khẩu">
                            </div>

                            <div class="mb-3">
                                <label for="radio">Giới Tính:</label>
